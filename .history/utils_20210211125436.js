...
function createPieceSprite(piece, rank, file, squareSize, pieceContainer, pieceTextures){
    ...
    let texture = pieceTextures[pieceIndex][Number(color)];
    let sprite = new PIXI.Sprite(texture);
    let point = new Point(file * squareSize + squareSize * 0.5, rank * squareSize + squareSize * 0.5);
    ...
    sprite.release = () => {
        ...
        sprite.position.set(closest_square.x, closest_square.y);
    };
}
